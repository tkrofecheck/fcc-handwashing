var app = (function () {
    ...
    /* src/ProgressBar.svelte generated by Svelte v3.55.0 */
    ...
    /* src/Timer.svelte generated by Svelte v3.55.0 */
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondsLeft*/ 1) {
    			$$invalidate(2, progress = parseInt((totalSeconds - secondsLeft) / totalSeconds * 100));
    		}
    	};
    ...
    /* src/HowTo.svelte generated by Svelte v3.55.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwashing.gif" alt="How to wash your hands" class="svelte-wwxt9"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    <a href="https://freesound.org/people/metrostock99/sounds/345086/">Sound Source</a>`;
    			...
    			audio_1.innerHTML = `<source src="public_sound.wav"/>`;
